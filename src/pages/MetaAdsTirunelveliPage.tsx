...
export default function MetaAdsTirunelveliPage({ onOpenConsultation }: Props) {
  const metaServices = [
    { title: 'High-Velocity Creative Testing', desc: 'Deploy 5+ visual ad variations weekly to isolate winning creative hooks and maximize ROAS.' },
    { title: 'Meta Conversions API (CAPI) Tracking', desc: 'Server-side attribution setup ensuring 100% accurate tracking immune to iOS privacy blockers.' },
    { title: 'Full-Funnel Retargeting Architecture', desc: 'Nurture cold prospects into buyers with dynamic video testimonials and direct WhatsApp offers.' },
    { title: '9:16 UGC & Commercial Video Creatives', desc: 'Short-form video ads engineered for scroll-stopping retention on Instagram Reels and Facebook.' },
    { title: 'Lookalike & Custom Audience Scaling', desc: 'Expand high-value customer lookalikes across Tirunelveli, southern districts, and statewide markets.' },
    { title: 'Direct WhatsApp Lead Routing', desc: 'Route inquiries directly into your sales team’s WhatsApp inbox with automated pre-filled greeting messages.' }
  ];
    ...
    <div className="w-full pt-20 sm:pt-28 pb-16 bg-[#F8FAFC] dark:bg-[#0F172A] min-h-screen">
      ...
      <section className="relative py-16 sm:py-24 overflow-hidden bg-gradient-to-b from-blue-50/50 via-white to-transparent dark:from-blue-950/20 dark:via-[#0F172A] dark:to-[#0F172A]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10 space-y-6">
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-blue-50 dark:bg-blue-950/60 border border-blue-200 dark:border-blue-800 text-xs font-bold text-[#2563EB]">
            ...
            <span>Meta Facebook &amp; Instagram Ads Agency</span>
          </div>
          ...
          <h1 className="font-heading font-extrabold text-4xl sm:text-6xl text-[#111827] dark:text-white tracking-tight leading-tight max-w-4xl mx-auto">
            Meta Ads Agency in Tirunelveli: <br />
            <span className="text-[#2563EB]">Scale Sales with High ROAS</span>
          </h1>

          <p className="text-base sm:text-xl text-[#64748B] dark:text-slate-300 max-w-3xl mx-auto leading-relaxed">
            Turn Facebook and Instagram into predictable customer acquisition engines. We build high-converting 9:16 video ad creatives, advanced CAPI server tracking, and direct WhatsApp lead funnels for brands in Tirunelveli and Tamil Nadu.
          </p>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
            ...
            >
              ...
              <span>Book Meta Ads Strategy Call</span>
            </button>
            <a
            ...
            >
              ...
              <span>Direct Founder: +91 63694 80812</span>
            </a>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center space-y-3 mb-12">
          <span className="text-xs font-extrabold uppercase tracking-widest text-[#2563EB]">Paid Acquisition Engine</span>
          <h2 className="font-heading font-extrabold text-3xl sm:text-4xl text-slate-900 dark:text-white">
            High-ROAS Meta Advertising Framework
          </h2>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
          {metaServices.map((item, idx) => (
            <div
              key={idx}
            ...
            >
              ...
              <div className="pt-4 border-t border-slate-100 dark:border-slate-800">
                <span className="text-[11px] font-bold text-[#10B981]">✓ Proven 3.5x to 6.2x ROAS Scaling</span>
              </div>
            </div>
          ))}
        </div>
      ...
      <section className="py-16 bg-slate-900 text-white text-center">
        <div className="max-w-4xl mx-auto px-4 space-y-6">
          <h2 className="font-heading font-extrabold text-3xl sm:text-4xl">
            Ready to Scale Your Facebook &amp; Instagram Ads?
          </h2>
          <p className="text-sm text-slate-300 max-w-xl mx-auto">
            Book a free 30-minute Meta Ads audit with founders Mohamed Thariq &amp; Muja to optimize your creative strategy and lower acquisition costs.
          </p>
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-2">
            ...
            >
              <Sparkles className="w-4 h-4 text-amber-300" />
              <span>Claim Free Meta Audit</span>
            </button>
            <Link
              to="/contact"
            ...
            >
              <span>Contact Paid Ads Team</span>
