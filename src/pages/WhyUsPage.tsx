...
export default function WhyUsPage({ onOpenConsultation }: WhyUsPageProps) {
  ...
  return (
    <div className="w-full pt-20 sm:pt-28 pb-16 bg-[#F8FAFC] dark:bg-[#0F172A] min-h-screen">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {differentiators.map((diff) => {
            ...
            return (
              <div
                key={diff.title}
                className="p-8 rounded-3xl bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 shadow-xl space-y-4 hover:shadow-2xl hover:-translate-y-1 transition-all"
              >
      ...
      <section className="py-16 sm:py-24 bg-white dark:bg-[#0B101D] border-t border-slate-200 dark:border-slate-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
          <div className="text-center space-y-3">
            <span className="text-xs font-extrabold uppercase tracking-widest text-[#2563EB]">Head-to-Head Comparison</span>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-5xl mx-auto">
            {/* Outdated Traditional Agencies Card */}
            <div className="p-8 rounded-3xl bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 space-y-6">
              ...
              <div className="space-y-4">
                {WHY_CHOOSE_US.others.map((item) => (
                  <div key={item.title} className="flex items-start gap-3 text-xs sm:text-sm">
            ...
            {/* TM Digital Marketing Premium Card */}
            <div className="p-8 rounded-3xl bg-gradient-to-b from-blue-600/10 via-slate-900 to-slate-900 border-2 border-[#2563EB] text-white shadow-2xl space-y-6 relative">
      ...
      {/* Founder Direct Guarantee Banner */}
      <section className="py-16 bg-gradient-to-r from-blue-600 to-sky-600 text-white text-center">
        <div className="max-w-4xl mx-auto px-4 space-y-6">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-2">
            <button
              ...
              className="w-full sm:w-auto font-btn font-bold px-8 py-4 rounded-2xl bg-white text-[#2563EB] shadow-xl hover:bg-blue-50 transition-all flex items-center justify-center gap-2"
            >
