...
export default function BlogIndexPage({ onOpenConsultation }: BlogIndexPageProps) {
  ...
  return (
    <div className="relative w-full pt-20 sm:pt-28 pb-16 bg-[#F8FAFC] dark:bg-[#0F172A] min-h-screen overflow-hidden">
      ...
      {/* Featured Pillar Article Banner (Side-Show Left & Right) */}
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
              ...
              <div className="lg:col-span-6 space-y-4 text-left">
                ...
                <div className="pt-2 flex items-center justify-between">
                  ...
                  <span className="inline-flex items-center gap-1 text-xs font-bold text-[#2563EB] group-hover:translate-x-1.5 transition-transform">
      ...
      <motion.section 
        ...
        whileInView="visible"
        viewport={defaultViewport}
        className="mt-16 py-16 bg-slate-900 text-white text-center"
      >
