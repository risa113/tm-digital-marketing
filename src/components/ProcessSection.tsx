          ...
          {PROCESS_STEPS.map((item: ProcessStep, index: number) => (
            ...
            >
              ...
              <div className="flex items-center justify-between mb-6">
                <span className="font-num font-extrabold text-4xl text-[#2563EB] dark:text-blue-400">
                  {item.step}
                </span>
                <div className="w-10 h-10 rounded-2xl bg-blue-50 dark:bg-blue-950/60 text-[#2563EB] flex items-center justify-center group-hover:scale-110 transition-transform">
                  <CheckCircle2 className="w-5 h-5" />
                </div>
              </div>

              <h3 className="font-heading font-extrabold text-xl text-[#111827] dark:text-white mb-3">
                {item.title}
              </h3>
